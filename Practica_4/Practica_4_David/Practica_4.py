...
class Practica_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica_4")
        ...
        self.Constelacion = Constelacion = (0+1j,0-1j,1,-1)
        ...
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1024)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_vector_sink_f_0, 0))
...
def main(top_block_cls=Practica_4, options=None):

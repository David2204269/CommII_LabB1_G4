...
import Practice_2_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class Practice_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practice_2", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practice_2")
...
def main(top_block_cls=Practice_2, options=None):
